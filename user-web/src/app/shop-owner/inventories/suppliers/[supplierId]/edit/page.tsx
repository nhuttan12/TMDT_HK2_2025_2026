...
import { getSupplierBySupplierId } from '@/services/inventories/suppliers/goods-supplier-service';
...
export default async function SupplierProductsPage({
	...
	const supplier: Supplier = await getSupplierBySupplierId(supplierId);
