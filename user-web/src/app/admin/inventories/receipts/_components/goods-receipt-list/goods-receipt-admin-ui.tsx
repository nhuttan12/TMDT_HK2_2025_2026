...
import { ProductBatchItemModal } from '@/app/admin/inventories/receipts/_components/goods-receipt-list/product-batch-item-modal';
...
import GoodsReceiptAdminTable
	from '@/app/admin/inventories/receipts/_components/goods-receipt-list/goods-receipt-admin-table';
