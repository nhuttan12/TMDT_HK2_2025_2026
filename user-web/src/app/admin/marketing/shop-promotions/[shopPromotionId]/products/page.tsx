...
import ShopProductPromotionContainer from '@/app/admin/marketing/shop-promotions/[shopPromotionId]/products/_components/shop-product-promotion-container';
...
export default async function StoreProductPromotionPage({ params }: Props): Promise<JSX.Element> {
	...
	return <ShopProductPromotionContainer promotionId={id} initialPromotions={initialPromotions} />;
}
