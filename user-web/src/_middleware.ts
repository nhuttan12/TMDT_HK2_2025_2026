...
const PROTECTED_ROUTES: string[] = ['/dashboard', '/profile', '/orders'];
...
export function middleware(request: NextRequest) {
	...
	const isProtectedRoute: boolean = PROTECTED_ROUTES.some((route) => pathname.startsWith(route));
	const isAuthRoute: boolean = AUTH_ROUTES.some((route) => pathname.startsWith(route));
