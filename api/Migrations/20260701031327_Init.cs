        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    min_invoice_value = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DELIVERIES_invoice_id",
                table: "DELIVERIES",
                column: "invoice_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DELIVERIES_shipping_status",
                table: "DELIVERIES",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_INVOICE_APPLIED_COUPONS_InvoiceId1",
                table: "INVOICE_APPLIED_COUPONS",
                column: "InvoiceId1",
                unique: true,
